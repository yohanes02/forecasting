...
class Lapincom extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata('logged_in') != "" && $this->session->userdata('level') == "Stocker") {
            ...
            $this->load->view('stocker/laporan/lapincom', $d);
        } else {
    ...
    public function print()
    {
        if ($this->session->userdata('logged_in') != "" && $this->session->userdata('level') == "Stocker") {
            ...
            $this->load->view('stocker/laporan/cetak/ctk_incom', $d);
        } else {
            redirect('auth/logout');
        }
    }
    ...
    public function pdf()
    {
        ...
        $this->pdf->load_view('stocker/laporan/pdf/lapincom_pdf', $d);
    }
    ...
    public function rqs()
    {
        if ($this->session->userdata('logged_in') != "" && $this->session->userdata('level') == "Stocker") {
            ...
            $this->session->set_userdata($st);
            redirect('stocker/lapincom/result');
        } else {
            redirect('auth/logout');
        }
    }
    ...
    public function result()
    {
        if ($this->session->userdata('logged_in') != "" && $this->session->userdata('level') == "Stocker") {
            ...
            $this->load->view('stocker/laporan/cetak/ctk_quality', $d);
        } else {
            redirect('auth/logout');
        }
    }
    ...
    public function set()
    {
        ...
        $this->session->set_userdata($st);
        redirect('stocker/lapincom/filter');
    }
}
