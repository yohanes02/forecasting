...
class Laporder extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata('logged_in') != "" && $this->session->userdata('level') == "Manager") {
            ...
            $this->load->view('Manager/laporan/laporder', $d);
        } else {
    ...
    public function print()
    {
        if ($this->session->userdata('logged_in') != "" && $this->session->userdata('level') == "Manager") {
            ...
            $this->load->view('Manager/laporan/cetak/ctk_laporder', $d);
        } else {
            redirect('auth/logout');
        }
    }
    ...
    public function xls()
    {
        if ($this->session->userdata('logged_in') != "" && $this->session->userdata('level') == "Manager") {
            ...
            $this->load->view('Manager/laporan/excel/xls_laporder', $d);
        } else {
            redirect('auth/logout');
        }
    }
    ...
    public function pdf()
    {
        ...
        $this->pdf->load_view('Manager/laporan/pdf/laporder_pdf', $d);
    }
    ...
    public function set()
    {
        ...
        $this->session->set_userdata($st);
        redirect('Manager/laporder/filter');
    }
}
