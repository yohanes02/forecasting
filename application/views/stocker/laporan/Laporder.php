                ...
                <div class="box-content card">
                    ...
                    <div class="group-row">
                        <div class="box-body">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php echo form_open_multipart('stocker/laporder/set', 'class="form-horizontal"'); ?>
                        ...
                        <p align="right" style="margin-top: 15px;">
                            <a href="<?php echo base_url(); ?>stocker/laporder/print" class="btn btn-xs btn-rounded btn-bordered btn-danger"><i class="fa fa-print"></i> Cetak</a>
                            <a href="<?php echo base_url(); ?>stocker/laporder/xls" class="btn btn-xs btn-rounded btn-bordered btn-danger"><i class="fa fa-file-excel-o"></i> Export Excel</a>
