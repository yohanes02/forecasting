                ...
                <div class="box-content card">
                    ...
                    <div class="group-row">
                        <div class="box-body">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php echo form_open_multipart('stocker/lapused/set', 'class="form-horizontal"'); ?>
                        ...
                        <p style="margin-top: 15px;margin-left:-100px;">
                            <a href="<?php echo base_url(); ?>stocker/lapused/print" class="btn btn-xs btn-rounded btn-bordered btn-danger"><i class="fa fa-print"></i> Cetak</a>
                            <a href="<?php echo base_url(); ?>stocker/lapused/xls" class="btn btn-xs btn-rounded btn-bordered btn-danger"><i class="fa fa-file-excel-o"></i> Export Excel</a>
                        </p>
                    </div>
