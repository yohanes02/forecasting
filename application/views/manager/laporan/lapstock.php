            ...
            <div class="col-xs-12">
                <div class="box-content card">
                    ...
                    <p class="form-group" align="right" style="margin-top: 15px;">
                        <a href="<?php echo base_url(); ?>Manager/lapstock/print" class="btn btn-xs btn-rounded btn-bordered btn-danger"><i class="fa fa-print"></i> Cetak</a>
                        <a href="<?php echo base_url(); ?>Manager/lapstock/xls" class="btn btn-xs btn-rounded btn-bordered btn-danger"><i class="fa fa-file-excel-o"></i> Download Excel</a>
