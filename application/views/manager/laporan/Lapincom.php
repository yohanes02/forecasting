...
<div id="modalrqs" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url('Manager/lapincom/rqs') ?>" id="form-rqs">
                <div class="modal-body">
                ...
                <div class="box-content card">
                    ...
                    <div class="group-row" style="position:absolute;z-index:2;">
                        <div class="box-body">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <?php echo form_open_multipart('Manager/lapincom/set', 'class="form-horizontal"'); ?>
                                    ...
                                    <span style="margin-left: 10px;">
                                        <a href="<?php echo base_url(); ?>Manager/lapincom/print" class="btn btn-xs btn-rounded btn-bordered btn-danger"><i class="fa fa-print"></i> Cetak</a>
