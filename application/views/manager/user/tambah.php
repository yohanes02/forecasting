        ...
        <div class="row small-spacing">
            <div class="col-lg-10 col-xs-12">
                <div class="box-content card white">
                    <h4 class="box-title">T A M B A H &nbsp; A K U N &nbsp; P E N G G U N A</h4>
                    <!-- /.box-title -->
                    <div class="card-content">
                        <?php echo form_open_multipart('manager/pengguna/simpan', 'class="form-horizontal"'); ?>
                        ...
                        <div class="form-group margin-bottom-0" style="margin-left: 65%;">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-info btn-sm btn-rounded waves-effect waves-light">Simpan</button>
