...
?>
<?php
foreach ($request->result_array() as $i) :
    $id = $i['id_request'];
    $kode = $i['kode'];
    $jumlah = $i['qty_barang'];
            ...
            <div class="row small-spacing">
                <div class="col-lg-10 col-xs-12">
                    <div class="box-content card white">
                        <h4 class="box-title">E D I T &nbsp; R E Q U E S T &nbsp; O R D E R</h4>
                        <!-- /.box-title -->
                        <div class="card-content">
                            <?php echo form_open_multipart('manager/approve/simpan_ubah', 'class="form-horizontal"'); ?>

                            <div class="form-group">
                                <label for="kode" class="col-sm-2 control-label">Kode Barang</label>
                                <div class="col-sm-10">
                                    <select class="form-control select2_1" name="kodeb" id="kodeb" onchange="changeValue(this.value)" disabled>
                                        ...
                                        while ($row = mysqli_fetch_array($result)) { ?>
                                            <option <?php echo ($k == $row['kode']) ? "selected" : "" ?>> <?php echo $row['kode'] ?></option> <?php
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="number" class="form-control" value="<?= $jumlah; ?>" id="jumlah" name="jumlah" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" value="<?= $tgl_kirim; ?>" class="form-control" id="tgl_kirim" name="tgl_kirim" required>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="form-group margin-bottom-0" style="margin-left: 65%;">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" class="btn btn-success btn-sm btn-rounded waves-effect waves-light">Approve</button>
                                    <a href="<?php echo site_url('manager/approve') ?>" class="btn btn-sm btn-rounded btn-warning">Batal</a>
                                </div>
                            </div>
                            <?php echo form_close(); ?>
                        </div>
