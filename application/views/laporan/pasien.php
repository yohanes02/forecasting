...
<section class="content">
    ...
    <div class="row">
        <?php echo form_open_multipart('laporan/pasien/set', 'class="form-horizontal"'); ?>

        <div class="col-xs-12">
            <div class="box box">
                <div class="box-header">
                    <h3 style="color: green;margin-right: 10px;"><b>Laporan Data Pasien</b></h3>
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            ?>
            <p align="left">
                <a href="<?php echo base_url(); ?>laporan/pasien/<?= $data; ?>" target="_blank" class="btn btn-primary"><i class="glyphicon glyphicon-file glyphicon-white"></i> Excel</a>
                <a href="<?php echo base_url(); ?>laporan/pasien/<?= $data2; ?>" target="_blank" class="btn btn-danger"><i class="glyphicon glyphicon-print glyphicon-white"></i> Cetak </a>
            </p>
            ...
            <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="background-color: rgb(46, 132, 33);color:white;">Nama Pasien</th>
                        <th style="background-color: rgb(46, 132, 33);color:white;">Umur</th>
                        <th style="background-color: rgb(46, 132, 33);color:white;">jekel</th>
                        <th style="background-color: rgb(46, 132, 33);color:white;">pekerjaan</th>
                        <th style="background-color: rgb(46, 132, 33);color:white;">tgl daftar</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
